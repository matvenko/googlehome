<?php  
        $sql = mysql_query("SELECT * FROM `reklama` WHERE id = 1");
                    ...
                    <p align="center">
                        ...
                        <div align="center">
                            <table border="0" width="97%" id="table1" cellspacing="0" cellpadding="0">
								...
								<textarea name="text_geo" class="jqte-test"><?php echo $row['text_geo']; ?></textarea>
								...
								<textarea name="text_eng" class="jqte-testeng"><?php echo $row['text_eng']; ?></textarea>
...
<?php
	...
	if(isset($_POST["send"]))
	{
		$update = mysql_query("UPDATE  `freeinfo_ge`.`reklama` SET  `text_geo` =  '".$text_geo."' WHERE  `reklama`.`id` =1;");
		$update = mysql_query("UPDATE  `freeinfo_ge`.`reklama` SET  `text_eng` =  '".$text_eng."' WHERE  `reklama`.`id` =1;");
