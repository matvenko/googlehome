...
<?php
	...
	if(isset($_POST["send"]))
	{
		$update = mysql_query("UPDATE  `freeinfo_ge`.`about` SET  `text_geo` =  '".$text_geo."' WHERE  `about`.`id` =1;");
		$update = mysql_query("UPDATE  `freeinfo_ge`.`about` SET  `text_eng` =  '".$text_eng."' WHERE  `about`.`id` =1;");
