...
if (isset($_GET['page']) && $_GET['page']=="edit_company")
{
...
<!-- ganc_tarigi -->
                            <tr>
                                ...
                                <td bgcolor="#FFFFFF">
                                    <input type="date" name="ganc_tarigi" value="<?php echo $edit_row["ganc_tarigi"]; ?>">
                                </td>
                            </tr>
...
<!-- Aqciis Upload -->                             
                            <tr>
                                ...
                                <td bgcolor="#FFFFFF" align="center">&nbsp;</td>
                                <td bgcolor="#FFFFFF">
                                  <input type="file" name="upload_aqcia" value="<?php if(isset($_POST['upload_aqcia']) && $_POST['upload_aqcia'] != ''){ echo $_POST['upload_aqcia']; }else{ echo $edit_row["upload_aqcia"]; } ?>" />
                                </td>
                            </tr>
...
<!-- aqciis saxeli geo -->                             
                            <tr>
                                ...
                                <td bgcolor="#FFFFFF" align="center">&nbsp;</td>
                                <td bgcolor="#FFFFFF">
                                    <input type="text" name="aqcia_name_geo" value="<?php echo $edit_row["aqcia_name_geo"]; ?>" />
                                </td>
                            </tr>
...
<!-- aqciis saxeli eng -->                             
                            <tr>
                                ...
                                <td bgcolor="#FFFFFF" align="center">&nbsp;</td>
                                <td bgcolor="#FFFFFF">
                                    <input type="text" name="aqcia_name_eng" value="<?php echo $edit_row["aqcia_name_eng"]; ?>" />
                                </td>
                            </tr>
...
<!-- Aqciis photo -->                             
                            <tr>
                                ...
                                <td bgcolor="#FFFFFF">
                                  ...
                                  <img src="<?php echo $image_dir.$edit_row["aqcia_photo"]; ?>" width="50" height="35" style="margin:10px;" />
                                </td>
                            </tr>
...
<!-- aqciis_piroba GEO -->                             
                            <tr>
                                ...
                                <td bgcolor="#FFFFFF" align="center">&nbsp;</td>
                                <td bgcolor="#FFFFFF">
                                <textarea name="aqcia_pirobebi_geo" class="jqte-aqciag" style="float:left"><?php echo $edit_row["aqcia_pirobebi_geo"]; ?></textarea>
                                <script>
                                    $('.jqte-aqciag').jqte();
...
<!-- aqciis_piroba  ENG-->                             
                            <tr>
                                ...
                                <td bgcolor="#FFFFFF" align="center">&nbsp;</td>
                                <td bgcolor="#FFFFFF">
                                <textarea name="aqcia_pirobebi_eng" class="jqte-aqciae" style="float:left"><?php echo $edit_row["aqcia_pirobebi_eng"]; ?></textarea>
                                <script>
                                    $('.jqte-aqciae').jqte();
