<?php  
        $sql = mysql_query("SELECT * FROM `about` WHERE id = 1");
                    ...
                    <p align="center">
                        ...
                        <div align="center">
                            <table border="0" width="97%" id="table1" cellspacing="0" cellpadding="0">
								...
								<textarea name="text_geo" class="jqte-test"><?php echo $row['about_geo']; ?></textarea>
								...
								<textarea name="text_rus" class="jqte-teste"><?php echo $row['about_rus']; ?></textarea>
								...
								<textarea name="text_eng" class="jqte-testeng"><?php echo $row['about_eng']; ?></textarea>
...
<?php
	...
	if(isset($_POST["send"]))
	{
		$update = mysql_query("UPDATE  `euroceil_ge`.`about` SET  `about_geo` =  '".$text_geo."' WHERE  `about`.`id` =1;");
		$update = mysql_query("UPDATE  `euroceil_ge`.`about` SET  `about_eng` =  '".$text_eng."' WHERE  `about`.`id` =1;");
		$update = mysql_query("UPDATE  `euroceil_ge`.`about` SET  `about_rus` =  '".$text_rus."' WHERE  `about`.`id` =1;");
