...
.paggg{float:left; width:28px; height:28px; margin:3px; border:1px solid #7db2dc; color:#000; background-color:#bfd3ed; font-size:12px; line-height:28px; text-align:center; border-radius:3px;  font-family:Arial; }

.paggg:hover{float:left; width:28px; height:28px;  margin:3px; border:1px solid #7db2dc; color:#F00; font-weight:bold; background-color:#FFFFFF; font-size:12px; line-height:28px; text-align:center; border-radius:3px; font-family:Arial;}
</style>
...
private $next_page_text = '<font color="#667" size="1" face="Arial, Helvetica, sans-serif">→</font>'; 
private $prev_page_text = '<font color="#667" size="1" face="Arial, Helvetica, sans-serif">←</font>'; 
...
{ 
    ...
    { 
        ...
        return '<a href="'.$url.'"><div class="paggg">'.$text.'</div></a>'; 
    } 
    return '<span><div style="float:left; width:28px; height:28px;  margin:3px; border:1px solid #7db2dc; color:#F00; font-weight:bold; background-color:#FFFFFF; font-size:12px; line-height:28px; text-align:center; border-radius:3px; font-family:Arial;">'.$text.'</div></span>'; 
} 
